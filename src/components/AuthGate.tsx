        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-200/50 dark:shadow-none space-y-6">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
            ...
            <span className={`text-[11px] font-medium px-2 py-0.5 rounded-full border ${
              ...
              {isCloudConnected ? 'Supabase Auth' : 'Local / Demo Mode'}
            </span>
          </div>
          ...
          <div className="space-y-3">
            {googleClientId ? (
              <div className="space-y-2">
                <div id="google-real-button-container" className="w-full flex justify-center py-1 min-h-[44px]" />
                <div className="flex items-center justify-between text-[11px] px-1 text-slate-400">
                  <span className="flex items-center gap-1 text-emerald-600 dark:text-emerald-400 font-medium">
                    <CheckCircle2 className="w-3 h-3" />
                    <span>Google Client ID Terhubung</span>
                  </span>
                  <button
                    type="button"
              ...
              <>
                ...
                <button
                  type="button"
                  onClick={() => setIsGoogleSetupOpen(true)}
                  className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/60 text-blue-600 dark:text-blue-400 font-semibold text-xs border border-blue-200 dark:border-blue-900/60 transition-colors"
                >
                  <Key className="w-3.5 h-3.5" />
                  <span>Koneksikan Google Client ID Asli (Panduan 2 Menit)</span>
                </button>
              </>
            )}
          </div>
